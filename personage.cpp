...
void personnage ::affiche_ennemi_attaque(int a)const
{
	int m2 = 5;
	int i;
...
void personnage ::affiche_ennemi_attaque2(int a)const
{
	int m2 = 5;
	int i;
...
void Robot:: affiche_ennemi_attaque(int a) const //affiche l'avatar du personnage, de la meme fa�on que les decors.
{
	int i;
	int m2 =5;
	switch(a)
...
void Robot:: affiche_ennemi_attaque2(int a) const //affiche l'avatar du personnage, de la meme fa�on que les decors.
{
	int i;
	int m2 =4;
	switch(a)
